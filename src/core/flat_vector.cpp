...
Vector FlatVector::create(DataType type, std::size_t row_count)
{
...
Vector FlatVector::wrap_external(DataType type,
                                 const void *data,
                                 ...
                                 Buffer::BufferLifetime lifetime)
{
    ...
    return Vector(type,
                  ...
                  row_count,
                  row_count,
                  Buffer::wrap_external(data, bytes, std::move(lifetime)));
}

void FlatVector::validate_access(const Vector &vector, DataType requested_type)
{
